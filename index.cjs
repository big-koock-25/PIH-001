...
const folder = path.join(__dirname, 'MyBlocklistFiles');
const urls = [
    ...
    'https://blocklist.sefinek.net/generated/v1/0.0.0.0/sites/anime.txt',
    'https://blocklist.sefinek.net/generated/v1/0.0.0.0/sites/anime2.txt',
    ...
    'https://blocklist.sefinek.net/generated/v1/0.0.0.0/crypto/sefinek.hosts.txt',
    ...
    'https://raw.githubusercontent.com/smokedzn/xiaomi-dns-filter/refs/heads/master/xiaomi_pihole_block.lst',
    'https://raw.githubusercontent.com/unknownFalleN/xiaomi-dns-blocklist/refs/heads/master/xiaomi_dns_block.lst',
    'https://raw.githubusercontent.com/hkamran80/blocklists/main/smart-tv.txt',
    // 'https://gist.githubusercontent.com/eterps/9ddb13a118a21a7d9c12c6165e0bbff5/raw/0ba4b04802a4b478d7777fb7abe76c8eac0c5bfc/Samsung%2520Smart-TV%2520Blocklist%2520Adlist%2520(for%2520PiHole)' // blocks Smart TV applications
];
...
async function downloadFiles() {
    for (let i = 0; i < urls.length; i++) {
        ...
        try {
            ...
            console.warn(`⚠️Failed to download - ${url}, ${err.message}`);
            fs.writeFileSync(filePath, `Failed to download - ${url}\n`, 'utf-8'); // Create empty placeholder
        }
    }
}
...
async function processFiles() {
    ...
    for (const file of files) {
        ...
        for await (const raw of rl) {
            ...
            if (!domain || domain.endsWith('.') || !domain.includes('.') || !/^[a-zA-Z0-9.-]+$/.test(domain)) continue;
...
(async function main() {
    ...
    console.log('✅ Done! All files are in "MyBlocklistFiles" folder');
})();
